...
class SshTunnel:
    ...
    def restart(self) -> None:
        ...
        the only outcome a user can act on. For the same reason ssh's stderr
        stops passing through to ours -- there is no longer a stream anyone is
        reading -- and goes back into the error instead.
